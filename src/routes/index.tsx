...
import { Check, Hammer, Menu, Quote, ShieldCheck, Sparkles, X } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/85 backdrop-blur">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 lg:px-12">
        ...
        <div className="hidden items-center gap-4 md:flex">
          ...
          <Link
            to="/auth"
            className="inline-flex items-center justify-center rounded-sm bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-[0_0_16px_oklch(var(--primary)/0.2)] transition-all hover:-translate-y-0.5 hover:bg-primary/90"
          >
            Démarrer mon projet
          </Link>
        </div>
        ...
        <div className="border-t border-border bg-background/95 md:hidden">
          <nav className="mx-auto flex max-w-7xl flex-col gap-1 px-6 py-4">
            <a
              href="#temoignages"
              onClick={close}
              className="rounded-sm px-3 py-2.5 text-sm font-medium text-muted-foreground hover:bg-muted hover:text-foreground"
            >
              Témoignages
            </a>
            <a
            ...
            <div className="mt-2 flex items-center gap-1 border-t border-border pt-3">
              ...
              <Link
                to="/auth"
                onClick={close}
                className="mt-1 block rounded-sm bg-primary px-3 py-2.5 text-center text-sm font-semibold text-primary-foreground"
              >
                Démarrer mon projet
              </Link>
            </div>
  ...
  return (
    <footer className="relative z-10 border-t border-border bg-card/40">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-sm text-sm font-light leading-relaxed text-muted-foreground">
              Le pilotage technique et financier des chantiers en Afrique de l'Ouest, au franc près.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <a href="#demo" className="text-foreground/80 transition-colors hover:text-primary">
                  Demander une démo
                </a>
              </li>
              <li>
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-2 px-6 py-5 text-xs text-muted-foreground sm:flex-row lg:px-12">
          <p>© {new Date().getFullYear()} BâtiBénin — Tous droits réservés.</p>
          <p>Construit pour les chantiers d'Afrique de l'Ouest · Cotonou, Bénin</p>
        </div>
      </div>
    </footer>
  );
...
function LandingPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden bg-background">
      ...
      <main className="relative z-10 flex-1 px-6 py-12 lg:px-12">
        <div className="mx-auto grid min-h-[calc(100vh-5rem)] w-full max-w-7xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
          {/* Left content */}
        ...
        <section
          id="temoignages"
          className="relative z-10 mx-auto mt-20 w-full max-w-7xl scroll-mt-8"
        >
