...
function seed() {
  ...
  const mkProvider = (p: {
    ...
    lat: p.lat ?? (p.city === "Cotonou" ? 6.3682 : 6.4405) + ((p.name.length % 5) - 2) * 0.004,
    lng: p.lng ?? (p.city === "Cotonou" ? 2.4273 : 2.3551) + ((p.name.length % 4) - 1) * 0.005,
    category: p.category,
    services: p.services,
  ...
  const orderDemo: DemoRow = {
    ...
    city: "Cotonou",
    phone: "+229 97 00 11 22",
    notes: "Paiement mobile money confirmé — livraison en cours (suivi sur carte).",
    ordered_at: shift(-1),
    created_at: shift(-1),
    updated_at: shift(-1),
    lat: 6.3569,
  ...
  const program: DemoRow[] = [
    {
      id: uid(),
      user_id: DEMO_USER,
      name: "Résidence Les Palmiers",
      description:
        "Résidence de standing : 2 immeubles d'appartements, boutiques et garages, sur la route de l'aéroport.",
      city: "Cotonou",
      address: "Route de l'aéroport, Cotonou",
      status: "commercialisation",
      budget_total: 650000000,
      start_date: shift(-120),
      end_date: shift(240),
      image_url: null,
      created_at: shift(-90),
  ...
  return {
    ...
    deliveries: [
      {
        id: uid(),
        order_id: orderDemo.id,
        driver_id: driverDemo.id,
        vehicle_id: null,
        user_id: DEMO_USER,
        status: "en_livraison",
        scheduled_at: shift(0),
        from_address: "Quincaillerie Le Bon Prix, Cotonou",
        to_address: orderDemo["delivery_address"],
        lat: orderDemo["lat"],
        lng: orderDemo["lng"],
        current_lat: 6.3621,
        current_lng: 2.4058,
        position_updated_at: shift(0),
        phone: orderDemo["phone"],
        weight: 2400,
        fee: orderDemo["delivery_fee"],
        proof_photo: null,
        signature_path: null,
        confirmation_code: "LIV-4821",
        delivered_at: null,
        created_at: shift(-1),
        updated_at: shift(0),
      },
    ...
    equipment_rentals: [
      ...
      },
      {
        ...
        deposit: 150000,
        delivery_fee: 15000,
        delivery_address: "Lot 452, Togoudo — Abomey-Calavi",
        scheduled_at: shift(3),
        returned_at: null,
        return_code: "R4W9XZ",
        deposit_paid: true,
        total_paid: false,
        total_paid_at: null,
        notes: "Groupe électrogène confirmé par le propriétaire, paiement intégral en attente.",
        status: "confirmee",
        created_at: shift(-2),
        updated_at: shift(-1),
      },
    ],
    development_programs: program,
    buildings,
    ...
    property_reservations: [
      {
        ...
        user_id: DEMO_USER,
        project_id: project.id,
        client_name: "Awa Sossou",
        client_phone: "+229 97 00 00 01",
        client_email: "awa.sossou@example.bj",
        amount: 35000000,
        deposit_paid: true,
        notes: "Acompte versé, dossier de crédit bancaire en cours.",
        status: "confirmee",
        created_at: shift(-12),
        updated_at: shift(-1),
      },
      {
        ...
        user_id: DEMO_USER,
        project_id: project.id,
        client_name: "Jean Mensah",
        client_phone: "+229 96 00 00 02",
        client_email: null,
        amount: 32000000,
        deposit_paid: false,
        notes: "Visite prévue samedi.",
        status: "demande",
        created_at: shift(-2),
        updated_at: shift(-2),
      },
